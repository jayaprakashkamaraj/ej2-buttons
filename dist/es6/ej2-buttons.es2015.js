import { Component, Event, EventHandler, KeyboardEvents, NotifyPropertyChanges, Property, addClass, createElement, detach, getInstance, getUniqueID, getValue, isRippleEnabled, removeClass, rippleEffect, setValue } from '@syncfusion/ej2-base';
...
function createCheckBox(enableRipple = false, options = {}) {
    let wrapper = createElement('div', { className: 'e-checkbox-wrapper' });
    if (options.cssClass) {
...
let RadioButton = RadioButton_1 = class RadioButton extends Component {
    ...
    preRender() {
        let element = this.element;
        this.tagName = this.element.tagName;
        element = wrapperInitialize('EJ-RADIOBUTTON', 'radio', element, WRAPPER$1);
        this.element = element;
